...
update employees
set salary = CASE WHEN position='Worker'    THEN 500
     WHEN position='Project manager'        THEN 1000
     WHEN position='Sale representative'    THEN 700
     WHEN position='Data Analyst'           THEN 700
     WHEN position='Administrator'          THEN 600
     WHEN position='Director'               THEN 1000
     ELSE 0 END +
             salary;
