    ...
    try:
        ...
        with engine.connect() as connection:
            insert_statement = employees_table.insert([
                ...
                dict(idnp='2102031023011', first_name='John', last_name='Smith', salary=10500,
                     position='Office manager'),
                dict(idnp='2102031012042', first_name='Kenau', last_name='Reeves', salary=9400,
                     position='Office manager'),
                dict(idnp='2102031011522', first_name='Kathy', last_name='Diaz', salary=15000,
                ...
                dict(idnp='2102031384568', first_name='Raymond', last_name='Johnson', salary=13000,
                     position='Project manager'),
                dict(idnp='2102031684583', first_name='Rebecca', last_name='Bell', salary=8000,
                ...
                dict(idnp='2102031489458', first_name='Clarence', last_name='Martin', salary=9000,
                     position='Data Analyst'),
                ...
                dict(idnp='2102065488233', first_name='John', last_name='Bailey', salary=6000,
                     position='Project manager'),
                ...
                dict(idnp='2102036981212', first_name='Paul', last_name='Walker', salary=10000,
                     position='Sale representative'),
                dict(idnp='2102031298148', first_name='Keith', last_name='Lopez', salary=15000,
                     position='Data Analyst'),
                dict(idnp='2102084856231', first_name='Thomas', last_name='Butler', salary=17000, position='Worker'),
                dict(idnp='2102036594893', first_name='Kathleen', last_name='Clark', salary=16000,
                     position='Data Analyst')
            ]
            )
